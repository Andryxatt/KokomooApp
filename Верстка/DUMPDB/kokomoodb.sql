...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Май 21 2019 г., 16:52
...
INSERT INTO `artists` (`artist_id`, `full_name`, `specialization`, `date_birthday`) VALUES
(1, 'Alex Greenberger', 'German mannerist painter', '2019-05-14');
...
(1, 'Vlasiuk Andrii', 'kaktys88@yandex.ru', NULL, '$2y$10$P7MCPqrCVfBjRVjxozVzqex6vd9G.npTvZmcOWEVBfjwu1Mo4TTXm', 'admin', NULL, 'camera.png', NULL, '2019-05-21 10:04:43', '2019-05-21 10:04:43');
...
--
ALTER TABLE `artists`
  MODIFY `artist_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
